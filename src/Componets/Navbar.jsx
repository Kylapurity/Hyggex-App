  ...
  return (
    <div className='flex items-center justify-between px-20 py-10'>
      ...
      <ul className='flex items-center gap-x-10 mr-20'>
        ...
        <li className='text-gray-800 hover:text-blue-500 cursor-pointer'>Flashcard</li>
        <li className='text-gray-800 hover:text-blue-500 cursor-pointer'>Contact</li>
        <li className='text-gray-800 hover:text-blue-500 cursor-pointer'>FAQ</li>
